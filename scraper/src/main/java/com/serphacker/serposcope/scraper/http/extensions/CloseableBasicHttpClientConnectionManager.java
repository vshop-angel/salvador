...
public class CloseableBasicHttpClientConnectionManager implements HttpClientConnectionManager, Closeable {
    ...
    public final ConnectionRequest requestConnection(
        ...
        return new ConnectionRequest() {
            ...
            public HttpClientConnection get(final long timeout, final TimeUnit tunit) {
                return CloseableBasicHttpClientConnectionManager.this.getConnection(
                        route, state);
            }
